        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <li class="menu-header fw-medium mt-4">
              <span class="menu-header-text">Acesso Cliente</span>
            </li>
            <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="{{ route('cliente.consorcios') }}" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-consolidate"></i>
                <div data-i18n="Email">Consórcios</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route('cliente.financeiro') }}" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-finance"></i>
                <div data-i18n="Email">Financeiro</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route('cliente.chamadas') }}" class="menu-link">
          ...
          <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                <!-- Notification -->
                @php
                if($cliente->imagem == "" && $cliente->dsGenero == 'Masculino'){
                    $avatar = "/public/materialize/img/avatars/1.png";
                }
                elseif($cliente->imagem == "" && $cliente->dsGenero == 'Feminino'){
                    $avatar = "/public/materialize/img/avatars/2.png";
                }
                else{
                    $avatar = "/public/img/clientes/".$cliente->imagem."?".date('YmdHis');
                }
                @endphp
                @if(testaChamadaNaoVisualizadaCliente($cliente->id))
                    <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-2 me-xl-1">
                      <a
                        class="nav-link btn btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow"
                        href="{{ route('cliente.chamadas') }}"
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="pages-account-settings-account.html">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-medium d-block">{{ $cliente->nmCliente }}</span>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ route('cliente.alterarSenha') }}">
