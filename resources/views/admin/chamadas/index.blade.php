                    ...
                    <div class="table-responsive">
                        <table class="tabela-index display" id="table-index">
                            ...
                            @foreach($chamadas as $chamada)
                              ...
                              @endphp
                              <tr>
                                  <td>@if($chamada->dsVisualizarAdmin == 'Não') <span class="start-50 translate-middle-y badge badge-dot bg-danger mt-2 border"></span> @endif</td>
                                  <td><span style='display:none'>{{ strtotime($chamada->dtHrChamada) }}</span>{{ $dtHrChamada }}</td>
                                  <td>{{ $chamada->nmCliente }}</td>
                                  ...
                                  <td>
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu" data-popper-placement="bottom-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(-101.111px, 134.444px);">
                                        <a class="dropdown-item waves-effect" href="{{ route('chamadas.acessar', $chamada->id_chamada) }}"><i class="mdi mdi-eye-outline me-1"></i> Acessar</a>
                                      </div>
                                    </div>
                                  </td>
                              </tr>
